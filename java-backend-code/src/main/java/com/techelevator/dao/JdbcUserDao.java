...
public class JdbcUserDao implements UserDao {
    ...
    public User getUserByUsername(String username) {
        ...
        User user = null;
        String sql = "SELECT user_id, username, password_hash, role, family_id FROM users WHERE username = ?;";
        try {
    ...
    public User createUser(RegisterUserDto user) {
        ...
        try {
            int newUserId = jdbcTemplate.queryForObject(insertUserSql, int.class, user.getUsername(), password_hash, ssRole, familyId);
